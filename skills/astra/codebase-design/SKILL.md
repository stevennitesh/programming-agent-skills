...
description: Resolve a consequential unresolved architecture or integration decision about ownership, interfaces, state, trust boundaries, or migration. Exclude routine implementation and whole-codebase audits.
---
