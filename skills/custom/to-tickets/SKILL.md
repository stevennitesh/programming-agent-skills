---
name: to-tickets
description: Explicitly turn one settled source into the smallest useful dependency-ordered implementation ticket graph and publish it to the configured tracker. Return one bounded item to Implement without creating a graph.
---
