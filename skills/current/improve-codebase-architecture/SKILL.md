...
- `$to-issues` for multi-slice candidates, even when the first slice is ready
- `$to-prd` when product behavior, user-facing concerns, parent spec, acceptance, architecture, or validation is unresolved
