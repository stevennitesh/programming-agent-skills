...
def test_prompt_3_materializes_m0_without_research_leakage_and_builds_exact_h1() -> None:
    ...
    for term in (
        ...
        "Freeze one candidate dependency set",
        "every referenced contract and every repo-owned acceptance test",
        "If the dependency fingerprint changes, stop before Prompt 4",
        "complete target-skill acceptance selection",
        "If completeness cannot be proved cheaply, run the full suite",
