...
======================
{
  "fixture": {
    ...
    "observations": [
      "K query times out.",
      "Status reads done.",
      "Claim state is unavailable."
    ],
    "permitted_tools": [
      "simulated refetch only"
    ],
    "requested_output": "Classify known and unknown effects, preserve C, and return one safe continuation without replay or rollback.",
    "source_facts": [
      "Commit C is verified.",
      "Intended effects are comment key K, status done, and claim release.",
      "Tracker owner provides no replay guarantee when a field cannot be read."
    ],
    "task": "Recover connector closeout after a provider error with incomplete observability."
  },
  "shared_authority": {
