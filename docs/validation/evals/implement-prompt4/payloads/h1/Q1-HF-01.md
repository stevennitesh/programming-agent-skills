...
======================
{
  "fixture": {
    ...
    "id": "Q1-HF-01",
    "initial_state": [
      "Each surface has an observable seam."
    ],
    "mutation_boundary": [
      "the five accepted surfaces"
    ],
    "observations": [],
    "permitted_tools": [
      "read supplied architecture map"
    ],
    "requested_output": "State the selected bounded change, proof story, included surfaces, excluded work, and authority boundary.",
    "source_facts": [
      "Acceptance requires request parsing, domain validation, persistence, response serialization, and an integration proof.",
      "A proposed patch changes only request parsing.",
      "All five surfaces are inside caller scope."
    ],
    "task": "Choose the implementation slice for a selected API field addition."
  },
  "shared_authority": {
