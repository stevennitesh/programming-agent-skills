...
======================
{
  "fixture": {
    ...
    "id": "Q1-HF-02",
    "initial_state": [
      "The command test is the highest meaningful seam."
    ],
    "mutation_boundary": [
      "accepted CLI behavior and proof"
    ],
    "observations": [],
    "permitted_tools": [
      "read supplied command map"
    ],
    "requested_output": "State one bounded change and disposition every named surface.",
    "source_facts": [
      "Acceptance requires parser, configuration handoff, help text, and an end-to-end command test.",
      "A proposed patch changes only the parser.",
      "An unrelated command cleanup is optional."
    ],
    "task": "Choose the implementation slice for a selected CLI flag."
  },
  "shared_authority": {
