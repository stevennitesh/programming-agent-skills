...
======================
{
  "fixture": {
    ...
    "observations": [],
    "permitted_tools": [
      "read supplied state matrix"
    ],
    "requested_output": "State the bounded implementation and proof branches without reducing scope to file count.",
    "source_facts": [
      "Acceptance requires dual-read, new-write, backfill guard, and legacy/current tests.",
      "Changing storage write alone would break legacy reads.",
      "All compatibility surfaces are authorized."
    ],
    "task": "Choose the implementation slice for a selected compatibility migration."
  },
  "shared_authority": {
