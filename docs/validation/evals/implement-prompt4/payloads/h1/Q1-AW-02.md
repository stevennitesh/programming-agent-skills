...
======================
{
  "fixture": {
    "cluster": "H1-01",
    "family": "adjacent-work",
    "id": "Q1-AW-02",
    "initial_state": [
      "The golden integration test is the proof seam."
    ],
    "mutation_boundary": [
      "accepted format behavior, fixture, and documentation"
    ],
    "observations": [],
    "permitted_tools": [
      "read supplied component map"
    ],
    "requested_output": "State one coherent accepted change, necessary coupled surfaces, and excluded refactor.",
    "source_facts": [
      "Acceptance requires formatter logic, golden fixture, and user-visible documentation.",
      "A broad report subsystem refactor is tempting but not required.",
      "The documentation change is required by acceptance."
    ],
