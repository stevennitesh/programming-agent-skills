...
======================
{
  "fixture": {
    ...
    "id": "Q2-LR-01",
    "initial_state": [
      "Item was open and claimed."
    ],
    "mutation_boundary": [
      "configured closeout fields"
    ],
    "observations": [
      "Refetch finds comment K present, status open, claim held."
    ],
    "permitted_tools": [
      "simulated query and refetch",
      "simulated safe missing-step mutation"
    ],
    "requested_output": "Reconcile actual effects and return or resume only owner-established safe missing steps.",
    "source_facts": [
      "Commit C is verified.",
      "Closeout requires comment key K, status done, and claim release.",
      "Tracker query by K is supported.",
      "Replay is safe only when K is confirmed absent."
    ],
    "task": "Recover connector closeout after a lost comment response."
  },
  "shared_authority": {
