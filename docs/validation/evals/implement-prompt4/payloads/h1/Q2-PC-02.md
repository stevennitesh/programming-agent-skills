...
======================
{
  "fixture": {
    ...
    "id": "Q2-PC-02",
    "initial_state": [
      "Status was active and the worker held the claim."
    ],
    "mutation_boundary": [
      "configured closeout fields"
    ],
    "observations": [
      "Refetch shows another actor set status blocked with a new blocker note; claim remains held."
    ],
    "permitted_tools": [
      "simulated refetch"
    ],
    "requested_output": "Classify effects and return the owner-matched continuation without overwriting concurrent state.",
    "source_facts": [
      "Commit C is verified.",
      "Intended effects are status done and claim release.",
      "Tracker owner forbids overwriting a concurrently changed status without caller judgment."
    ],
    "task": "Recover connector closeout after a concurrent provider change."
  },
  "shared_authority": {
