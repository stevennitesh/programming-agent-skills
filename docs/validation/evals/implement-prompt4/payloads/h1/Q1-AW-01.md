...
======================
{
  "fixture": {
    ...
    "id": "Q1-AW-01",
    "initial_state": [
      "The bug cause and red-capable reproduction are settled."
    ],
    "mutation_boundary": [
      "invalidation behavior and regression proof"
    ],
    "observations": [],
    "permitted_tools": [
      "read supplied source map"
    ],
    "requested_output": "State the self-contained change and Return the adjacent debt.",
    "source_facts": [
      "Acceptance requires invalidation on update plus regression proof.",
      "The same module has unrelated naming and lint debt.",
      "Cleanup of that debt is not authorized."
    ],
    "task": "Choose the implementation slice for a selected cache invalidation bug."
  },
  "shared_authority": {
