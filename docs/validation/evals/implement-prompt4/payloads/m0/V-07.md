...
======================
{
  "fixture": {
    ...
    "requested_output": "Name the correct inner owner, its required Return, and the resume boundary.",
    "source_facts": [
      "Expected behavior is settled.",
      "The exact symptom is observed.",
      "The cause and trusted red-capable reproduction are unknown."
    ],
    "task": "Fix a selected production bug."
  },
  "shared_authority": {
