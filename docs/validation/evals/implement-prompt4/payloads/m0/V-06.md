...
======================
{
  "fixture": {
    ...
    "requested_output": "Return the missing Charter decision before mutation; do not invent a numeric budget.",
    "source_facts": [
      "No caller, repository, or risk authority establishes a finite Repair budget.",
      "All other Charter fields are settled."
    ],
    "task": "Implement a selected ready compatibility fix whose review route and proof lane are settled."
  },
  "shared_authority": {
