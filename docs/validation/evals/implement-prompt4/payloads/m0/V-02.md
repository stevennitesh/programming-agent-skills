...
======================
{
  "fixture": {
    ...
    "mutation_boundary": [],
    "observations": [
      "No alternative item is authorized."
    ],
    "permitted_tools": [
      "read-only source and tracker state"
    ],
    "requested_output": "Return the exact failed gate and owner action without substitution, readiness repair, claim, or code change.",
    "source_facts": [
      "The named target is binding.",
      "Repository Ready-for-agent policy requires dependencies satisfied."
    ],
    "task": "Implement the supplied GitHub issue whose acceptance is settled but whose dependency issue remains open."
  },
  "shared_authority": {
