...
======================
{
  "fixture": {
    ...
    "observations": [],
    "permitted_tools": [
      "read repository setup pointers"
    ],
    "requested_output": "Return the setup precondition and unchanged work/tracker state.",
    "source_facts": [
      "The repository AGENTS.md requires tracker guidance.",
      "The configured tracker file is missing."
    ],
    "task": "Implement the selected Local Markdown item."
  },
  "shared_authority": {
