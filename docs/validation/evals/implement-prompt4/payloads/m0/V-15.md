...
======================
{
  "fixture": {
    ...
    "requested_output": "Return completion at the authorized boundary without push or remote-verification claims.",
    "source_facts": [
      "Push was not separately authorized."
    ],
    "task": "Finish a proved, reviewed, committed direct item."
  },
  "shared_authority": {
