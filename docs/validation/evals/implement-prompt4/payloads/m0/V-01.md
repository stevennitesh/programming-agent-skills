...
{
  "fixture": {
    "family": "outcome-invocation",
    "id": "V-01",
    "initial_state": [
      "Setup is compatible.",
      "Worktree is clean.",
      "Fixed point is HEAD A.",
      "Proof lane is the report command integration test."
    ],
    "mutation_boundary": [
    ...
    "observations": [
      "Review accepts the proved lock candidate.",
      "Commit C has the lock tree."
    ],
    "permitted_tools": [
      "shared_tools"
    ],
    "prompt4_source_repair": "Added the required finite Repair budget; task and rubric unchanged.",
    "requested_output": "Give the owner sequence and final completion packet; tracker state must be not applicable.",
    "source_facts": [
      "Outcome and acceptance are settled.",
      "The item is one bounded slice.",
      "No tracker backs the item.",
      "The settled finite Repair budget is one generation."
    ],
    "task": "Deliver the explicitly selected direct item that adds JSON export for the report command."
  },
  "shared_authority": {
