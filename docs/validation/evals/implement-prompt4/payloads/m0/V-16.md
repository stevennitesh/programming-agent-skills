...
======================
{
  "fixture": {
    ...
    "id": "V-16",
    "initial_state": [
      "Item is still open and claimed."
    ],
    "mutation_boundary": [],
    "observations": [
      "No closeout refetch is available."
    ],
    "permitted_tools": [
      "read supplied state"
    ],
    "requested_output": "Return nonterminal status, failed gate, evidence gap, claim state, and exact resume action.",
    "source_facts": [
      "Acceptance, proof, review, Lock, and commit C pass.",
      "Configured closeout and claim release must read back."
    ],
    "task": "Assess whether a connector-backed item is complete."
  },
  "shared_authority": {
