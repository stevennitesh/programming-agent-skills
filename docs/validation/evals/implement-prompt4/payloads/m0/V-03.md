...
======================
{
  "fixture": {
    ...
    "requested_output": "Return the complete shaping handoff and stop without choosing or implementing a child.",
    "source_facts": [
      "The plan contains four unsliced outcomes.",
      "No singleton is selected.",
      "No explicit parent-graph delivery request is present."
    ],
    "task": "Implement everything in the supplied parent plan."
  },
  "shared_authority": {
