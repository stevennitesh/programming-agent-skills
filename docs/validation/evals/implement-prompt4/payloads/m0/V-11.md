...
{
  "fixture": {
    "family": "lock-identity",
    "id": "V-11",
    "initial_state": [
      "Review tree is R.",
      "Current index tree is L."
    ],
    "mutation_boundary": [],
    "observations": [
      "R-to-L diff contains an implementation logic change introduced after review."
    ],
    "permitted_tools": [
      "read Git diff and trees"
    ],
    "requested_output": "Return to formal review with the identity evidence; do not commit.",
    "source_facts": [
      "Only verified repository-local closeout metadata may differ after review.",
      "This direct item has no tracker closeout."
    ],
    "task": "Lock an accepted direct-item candidate."
  },
  "shared_authority": {
