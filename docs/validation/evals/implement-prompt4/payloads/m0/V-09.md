...
{
  "fixture": {
    "family": "review-repair",
    "id": "V-09",
    "initial_state": [
      "The immutable review tree is T1."
    ],
    "mutation_boundary": [],
    "observations": [
      "The report is complete and current."
    ],
    "permitted_tools": [
      "read review packet",
      "read Finding Contract"
    ],
    "requested_output": "Return the complete decision packet; do not partially repair F1.",
    "source_facts": [
      "Repair budget has one generation remaining.",
      "Review reports F1 automatic-in-scope, F2 product-decision-required, and F3 unrelated."
    ],
    "task": "Resolve a formal review of the selected proved candidate."
  },
  "shared_authority": {
