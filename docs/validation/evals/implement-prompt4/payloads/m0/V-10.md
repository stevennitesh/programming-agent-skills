...
{
  "fixture": {
    "family": "local-closeout-order",
    "id": "V-10",
    "initial_state": [
      "Review tree R is accepted.",
      "Selected work is staged."
    ],
    "mutation_boundary": [
      "configured local tracker file"
    ],
    "observations": [
      "Notes and status write succeed.",
      "Claim removal fails.",
      "Tracker file is partly staged."
    ],
    "permitted_tools": [
      "simulated local tracker mutation",
      "read Git index"
    ],
    "requested_output": "Return staged incomplete tracker state and safest recovery; do not Lock, commit, or complete.",
    "source_facts": [
      "Tracker policy requires notes, implemented status, claim removal, staging with selected work, and Mutation read-back.",
      "Local closeout occurs after review and before Lock."
    ],
    "task": "Finish an accepted Local Markdown-backed implementation."
  },
  "shared_authority": {
