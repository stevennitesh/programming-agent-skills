...
- Needed back: launch window constraints; readiness gates; rollback threshold and owner; support coverage; communication constraints; Morgan's largest unlisted risk
...
- Requested target: `authorized/concurrent.md`
- Overwrite authority: no
- Sensitivity: internal operational information; placement inside the authorized root is approved
- Inspection-time target content: `INSPECTED`
- Immediate pre-Save target content after an external change: `CONCURRENT`
