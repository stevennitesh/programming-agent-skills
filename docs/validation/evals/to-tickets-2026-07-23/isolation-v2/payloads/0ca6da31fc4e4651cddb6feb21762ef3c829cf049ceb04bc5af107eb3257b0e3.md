...
```json
{
  ...
  "context": "Repository setup is compatible. The source owner authorizes standalone issues and explicitly states no parent issue exists or should be created.",
  "source_packet": {
    "identity": "SRC-V02@1",
    ...
    "acceptance": [
      "--format json emits the specified keys",
