...
**Consequences**:
`AGENTS.md` should stay short and should not duplicate full skill procedures. The engineering contract carries the philosophy; each skill carries only the contract slice needed for its own behavior.
