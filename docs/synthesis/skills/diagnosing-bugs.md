...
| --- | --- | --- | --- | --- | --- |
| `I1,I2 / E1` | `D1,D2` | [Invocation](#invocation-and-admission) and [relationships](#relationship-ownership) | Each missing bug fact routes to Diagnosis; all four known before TRACE route to TDD; direct, caller, lane, Wayfinder, and conflict modes return to the correct owner | Severity, a failing test, a proposed patch, or known behavior plus unknown cause routes to TDD; unchanged facts bounce | Invocation-policy and relationship tests plus fresh-context routing samples |
