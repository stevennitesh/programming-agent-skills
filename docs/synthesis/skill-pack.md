...
Revision 14 puts To Tickets in the generated candidate Analyze prompt and
Implement in the resulting Ready-for-agent prompt. To Tickets retains issue
publication; Audit retains candidate judgment, report publication, and Return.
...
handoff.
Revision 35 materializes machine contract revision 23 by keeping Audit
Codebase's organized HTML map, exhaustive subsystem accounting, user-selected
subsystem coverage, and user-selected candidate analysis while removing
...
Revision 47 materializes machine contract revision 35 by preserving three
caller-visible contract details through the specification-to-implementation
path. To Spec defines item-local failure, stable result shapes and field
meaning, and governing identity triggers when present. To Tickets places any
violable parent invariant and its smallest decisive mixed-input case in the
...
Revision 50 materializes machine contract revision 38 by preserving exact
caller-visible acceptance through the specification-to-implementation path.
To Spec defines shared-display freshness and item-versus-request issue scope.
To Tickets carries source-named discriminators, named result invariants,
responsive behavior, and timezone boundaries into the consuming ticket.
Implement binds completion claims to specific distinguishing proof, complete
...
```json
{
  "capabilities": [
    ...
    },
    {
      ...
      "observable_outcome": "Answer one bounded source-answerable question with cited evidence for a caller-owned decision",
    ...
    },
    {
      ...
      "completion_return": "A supported design verdict with evidence, limits, and cleanup state",
      "disposition": "selected",
      "entry_conditions": [
        "One design choice needs runnable evidence rather than production proof"
      ],
      "essential": true,
      "exclusions": [
        "Shared or implicit final authority",
      ...
      "observable_outcome": "Produce one disposable runnable verdict for one bounded design question",
      "primary_owner_skill_id": "SK-004",
      "proof_class": "fresh behavioral proof plus structural identity and boundary proof",
      "required_authority_mutation": [
        "Disposable probe design, execution, evidence, and cleanup"
      ]
    },
    {
      "acceptance_scenario_ids": [
    ...
    },
    {
      ...
      "observable_outcome": "Deliver one red-green-refactor tracer for settled red-testable behavior",
      "primary_owner_skill_id": "SK-006",
      "proof_class": "fresh behavioral proof plus structural identity and boundary proof",
      "required_authority_mutation": [
        "Tracer selection, RED observation, minimal GREEN implementation, and refactor proof"
      ]
    },
    {
      "acceptance_scenario_ids": [
      ...
      "completion_return": "One selected bounded design with caller-facing proof surface",
      "disposition": "selected",
      "entry_conditions": [
        "One module, interface, seam, adapter, ownership boundary, or caller-facing test surface needs a decision"
      ],
      "essential": true,
      "exclusions": [
        "Shared or implicit final authority",
      ...
      "observable_outcome": "Design one bounded module behind a small caller-facing interface",
      "primary_owner_skill_id": "SK-007",
      "proof_class": "fresh behavioral proof plus structural identity and boundary proof",
      "required_authority_mutation": [
        "Bounded module responsibilities, interface, seam, alternatives, and design proof"
      ]
    },
    {
      "acceptance_scenario_ids": [
    ...
    },
    {
      ...
      "proof_class": "fresh behavioral proof plus structural identity and boundary proof",
      "required_authority_mutation": [
        "Questionnaire scope, question wording, artifact creation, and verification"
      ]
    },
    {
      "acceptance_scenario_ids": [
    ...
    },
    {
      ...
      "completion_return": "One verified durable current-source HTML report for exactly one user-selected Map, Audit, or Analyze invocation, with current selectable subsystems or candidates and no downstream work started",
      "disposition": "selected",
      "entry_conditions": [
        "A repository needs a new or updated exhaustive live-worktree map, one user-selected subsystem audit, or one user-selected candidate analysis"
      ],
      "essential": true,
      "exclusions": [
        "Shared or implicit final authority",
      ...
      "observable_outcome": "Map one live-worktree repository target, audit one user-selected subsystem, or analyze one user-selected candidate in an organized HTML report without selecting the next item or starting implementation",
      "primary_owner_skill_id": "SK-017",
      "proof_class": "fresh behavioral proof plus structural identity and boundary proof",
      "required_authority_mutation": [
        "Current-source identity and manifest verification, linked system map, six-class subsystem coverage, systemic pattern evidence, improvement candidates, candidate analysis, and one atomic durable HTML report"
      ]
    },
    {
      "acceptance_scenario_ids": [
  ...
  "epoch_header": {
    "acceptance_scenarios": [
      ...
      {
        "description": "Positive entry, nearest-negative exclusion, material failure, and completion for research: Answer one bounded source-answerable question with cited evidence for a caller-owned decision",
        "expected_owner_skill_id": "SK-003",
        "scenario_id": "PS-003"
      },
      {
        "description": "Positive entry, nearest-negative exclusion, material failure, and completion for prototype: Produce one disposable runnable verdict for one bounded design question",
      ...
      {
        "description": "Positive entry, nearest-negative exclusion, material failure, and completion for tdd: Deliver one red-green-refactor tracer for settled red-testable behavior",
        "expected_owner_skill_id": "SK-006",
        "scenario_id": "PS-006"
      },
      {
        "description": "Positive entry, nearest-negative exclusion, material failure, and completion for codebase-design: Design one bounded module behind a small caller-facing interface",
        "expected_owner_skill_id": "SK-007",
        "scenario_id": "PS-007"
      },
      {
        "description": "Positive entry, nearest-negative exclusion, material failure, and completion for grilling: Stress-test one bounded plan, decision, or idea conversationally until shared understanding is confirmed",
        "expected_owner_skill_id": "SK-008",
        "scenario_id": "PS-008"
      },
      {
      ...
      {
        "description": "Positive entry, nearest-negative exclusion, material failure, and completion for audit-codebase: Map one repository target, audit one user-selected subsystem, or analyze one user-selected candidate in the organized HTML report without starting downstream work",
    ...
    "campaign_proof_graph": [
      ...
      {
        "predecessor_skill_id": "SK-010",
        "successor_skill_id": "SK-025"
      },
      {
        "predecessor_skill_id": "SK-011",
        "successor_skill_id": "SK-025"
      },
      {
        "predecessor_skill_id": "SK-012",
        "successor_skill_id": "SK-017"
      },
      {
        "predecessor_skill_id": "SK-012",
      ...
      {
        "predecessor_skill_id": "SK-017",
        "successor_skill_id": "SK-025"
      },
      {
        "predecessor_skill_id": "SK-018",
        "successor_skill_id": "SK-025"
      },
      {
      ...
      {
        "predecessor_skill_id": "SK-021",
        "successor_skill_id": "SK-025"
      },
      {
        "predecessor_skill_id": "SK-022",
        "successor_skill_id": "SK-025"
      },
      {
    ...
    "exclusions": [
      ...
      "Runtime skill edits or one-skill campaign execution",
      "Pack integration acceptance or efficacy claims",
      "Historical cleanup, compatibility retirement, installation, push, or Git delivery",
      "Universal optimality beyond the tested finite epoch"
    ],
    "fixed_point": {
      "environment": "surface=Codex Desktop; model=gpt-5.6-sol; reasoning_effort=medium; thread_id=019f9c92-07fb-7b80-b8a2-a218bbfd9a1f; workspace_kind=project; operating_system=Windows; shell=PowerShell; python=3.12.12; filesystem_authority=workspace-write; request_sandbox=windows_elevated; evidence_tools=workspace exec, GitHub connector/gh read fallback, Node REPL request metadata",
      "repository_tree": "97cb4931b0c91964b5f86ea2931875fd46168be5",
      "timestamp": "2026-07-27T05:34:05Z"
    },
    "integration_result": {
      "decision": null,
      "evidence_pointer": null
    },
    "intended_pack_outcome": "Route bounded repository engineering work to one clear owner, conditionally load compact procedure, preserve semantic and mutation authority across typed composition, and converge under fresh observable proof in the tested Codex environment.",
    "load_budget_policy": {
      "ceiling_or_class": "Always load metadata only; load one selected owner procedure; load aggregate callees and branch references only after their predicates; never copy foreign procedure",
      "metric": "UTF-8 instruction bytes classified as metadata, selected-owner common, aggregate-callee conditional, or branch-reference conditional",
      "status": "set"
    },
    "research_bound": {
    ...
    "schema_version": 1,
    "scope": [
      "Repository engineering route selection, setup, domain capture, evidence, shaping, design, diagnosis, delivery, conflict resolution, review, improvement, skill authoring, and resumable handoff",
      "Capability-owner, role, invocation, relationship, exclusion, collision, gap, context-load, and proof-order composition",
      "Immutable one-skill campaign slices and serial campaign proof order"
    ],
    "source_pointers": [
      "docs/research/skill-pack-composition/epochs/FCE-20260727-01/pre-discovery-fixed-point.json#sha256-v1:98a9c9f84c788049557fc4f352f8c9b3c862f0d6da083c5751001acd1357e2d9",
  ...
  "exclusions_collisions_gaps": [
    {
      "class": "exclusion",
      "essential": true,
      "future_owner_or_stopping_condition": null,
      "governing_owner": "Pack Contract owner",
      ...
      "observable_conflict": "Prior epoch semantics, incumbent wording, and current count could anchor discovery",
      "resolution": "The fixed-point independent packet was recorded without skill names before Catalog or current inventory reconciliation",
      "status": "resolved",
      "terms": []
    },
    {
      ...
      "negative_control_scenario_id": "PS-003",
      "nondependency_proof_ids": [],
      "observable_conflict": "Catalog retrieval could rank, adopt, or select pack behavior",
      "resolution": "Catalog access followed the exact independent-packet fingerprint; the admitted Catalog was empty and selection remained with the Pack Contract owner",
      "status": "resolved",
      "terms": []
    },
    {
      ...
      "nondependency_proof_ids": [],
      "observable_conflict": "An essential M0 capability could remain ownerless or multiply owned",
      "resolution": "Each independently discovered capability family maps to exactly one selected primary owner; contributors return typed subresults only",
      "status": "resolved",
      "terms": []
    },
    {
      ...
      "negative_control_scenario_id": "PS-025",
      "nondependency_proof_ids": [],
      "observable_conflict": "The general router and local route-producing skills could both own destination execution",
      "resolution": "Only skill-router owns general route choice; every Recommend and stop edge leaves the explicit destination unstarted",
      "status": "resolved",
      "terms": []
    },
    {
      ...
      "nondependency_proof_ids": [],
      "observable_conflict": "Executable aggregates could copy callee gates or share completion",
      "resolution": "Every aggregate relationship preserves callee-local gates and names one resume owner and one combined-exit owner",
      "status": "resolved",
      "terms": []
    },
    {
      ...
      "issue_id": "ECG-006",
      "negative_control_scenario_id": "PS-006",
      "nondependency_proof_ids": [],
      "observable_conflict": "Bidirectional runtime handoffs could create a hard campaign dependency cycle",
      "resolution": "Runtime handoffs use frozen contract-interface fixtures where reciprocal behavior exists; only exact promoted-interface dependencies enter the acyclic proof graph",
      "status": "resolved",
      "terms": []
    },
    {
      ...
      "nondependency_proof_ids": [],
      "observable_conflict": "Shared vocabulary and relationships could load foreign procedures into every caller",
      "resolution": "Metadata is always available, exactly one owner procedure is conditional, and branch references load only when their predicate is met",
      "status": "resolved",
      "terms": []
    },
    {
      ...
      "nondependency_proof_ids": [],
      "observable_conflict": "Recommendation edges to explicit-only skills could silently authorize mutation",
      "resolution": "Every explicit-only destination uses Recommend and stop; a later caller invocation supplies separate authority",
      "status": "resolved",
      "terms": []
    },
    {
      ...
      "negative_control_scenario_id": "PS-025",
      "nondependency_proof_ids": [],
      "observable_conflict": "Repeated leading words such as route, review, proof, design, decision, complete, and Return could make adjacent owners indistinguishable",
      "resolution": "Each repeated term is bounded by mutually exclusive positive and nearest-negative predicates, one primary capability owner, and a typed relationship verb; skill-router alone owns general route choice and stops before destination execution",
      "status": "resolved",
      "terms": [
        "route",
        "review",
  ...
  "relationships": [
    ...
    },
    {
      ...
      "caller_skill_id": "SK-020",
      "combined_exit_owner_skill_id": "SK-020",
      "context_loaded": [
    ...
    },
    {
      ...
      "combined_exit_owner_skill_id": "SK-008",
      "context_loaded": [],
      "entry_condition": "An identifiable external stakeholder owns evidence that must be collected asynchronously.",
      "failure_behavior": "Return the recommendation or suggestion without executing the target",
      "input_packet": "Caller-owned bounded Source Trace for grilling and the declared to-questionnaire input",
      "ordering_impact": "none",
    ...
    },
    {
      ...
      "context_loaded": [],
      "entry_condition": "One candidate has a bounded, non-diagnostic question that claim-owning sources can answer.",
    ...
    },
    {
      ...
      "combined_exit_owner_skill_id": "SK-017",
      "context_loaded": [],
      "entry_condition": "One selected candidate needs a disposable runnable probe or comparative measurement before judgment.",
      "failure_behavior": "Return the recommendation without invoking the target; preserve the candidate and report for user-selected continuation",
      "input_packet": "Durable audit report, candidate identity, analysis, route prerequisite, and exact suggested invocation",
      "ordering_impact": "none",
    ...
    },
    {
      ...
      "combined_exit_owner_skill_id": "SK-017",
      "context_loaded": [],
      "entry_condition": "One candidate decision belongs to the user and also requires current domain records.",
    ...
    },
    {
      ...
      "combined_exit_owner_skill_id": "SK-017",
      "context_loaded": [],
      "entry_condition": "One identifiable external stakeholder owns required evidence unavailable from current sources.",
      "failure_behavior": "Return the recommendation without invoking the target; preserve the candidate and report for user-selected continuation",
      "input_packet": "Durable audit report, candidate identity, analysis, route prerequisite, and exact suggested invocation",
      "ordering_impact": "none",
    ...
    },
    {
      ...
      "combined_exit_owner_skill_id": "SK-017",
      "context_loaded": [],
      "entry_condition": "One candidate has several coupled unresolved questions or prerequisites and needs durable multi-session sequencing.",
      "failure_behavior": "Return the recommendation without invoking the target; preserve the candidate and report for user-selected continuation",
      "input_packet": "Durable audit report, candidate identity, analysis, route prerequisite, and exact suggested invocation",
      "ordering_impact": "none",
    ...
    },
    {
      ...
      "combined_exit_owner_skill_id": "SK-017",
      "context_loaded": [],
      "entry_condition": "One material candidate decision belongs to the current user and needs no domain-record maintenance.",
      "failure_behavior": "Publish the decision brief and return the recommendation without invoking the target; preserve the candidate for later Analyze",
      "input_packet": "One digest-bound current audit report, candidate identity, last verified source identity, and complete decision brief",
      "ordering_impact": "none",
    ...
    },
    {
      ...
      "combined_exit_owner_skill_id": "SK-017",
      "context_loaded": [],
      "entry_condition": "One analyzed candidate has settled direction and commitments that need a durable parent specification.",
      "failure_behavior": "Return the recommendation without invoking the target; preserve the candidate and report for user-selected continuation",
      "input_packet": "Durable audit report, candidate identity, analysis, route prerequisite, and exact suggested invocation",
      "ordering_impact": "none",
    ...
    },
    {
      ...
      "combined_exit_owner_skill_id": "SK-017",
      "context_loaded": [],
      "entry_condition": "One analyzed candidate is a bounded behavior-preserving reduction with current evidence and a Proof Seam.",
      "failure_behavior": "Return the recommendation without invoking the target; preserve the candidate and report for user-selected continuation",
      "input_packet": "Durable audit report, candidate identity, analysis, route prerequisite, and exact suggested invocation",
      "ordering_impact": "none",
    ...
    },
    {
      ...
      "combined_exit_owner_skill_id": "SK-017",
      "context_loaded": [],
      "entry_condition": "One analyzed candidate is a bounded implementation-ready change and the user has not selected implementation yet.",
      "failure_behavior": "Return the analyzed candidate and leave implementation unstarted",
      "input_packet": "Current audit report, candidate identity, current evidence, bounded recommendation, affected callers, and Proof Seam",
      "ordering_impact": "none",
      ...
      "resume_owner_skill_id": "SK-017",
      "return_packet": "One concise Implement recommendation with implementation unstarted",
    ...
    },
    {
      ...
      "failure_behavior": "Return the recommendation or suggestion without executing the target",
      "input_packet": "Caller-owned bounded Source Trace for to-questionnaire and the declared grilling input",
      "ordering_impact": "none",
      "relationship_id": "REL-076",
      "required_proof_ids": [
        "PROOF-REL-076"
      ],
    ...
    },
    {
      ...
      "failure_behavior": "Return the recommendation or suggestion without executing the target",
      "input_packet": "Caller-owned bounded Source Trace for to-spec and the declared repo-bootstrap input",
      "ordering_impact": "none",
      "relationship_id": "REL-079",
      "required_proof_ids": [
        "PROOF-REL-079"
      ],
    ...
    },
    {
      ...
      "entry_condition": "A required setup surface is missing or incompatible.",
      "failure_behavior": "Return the recommendation or suggestion without executing the target",
      "input_packet": "Caller-owned bounded Source Trace for to-tickets and the declared repo-bootstrap input",
      "ordering_impact": "none",
      "relationship_id": "REL-083",
      "required_proof_ids": [
        "PROOF-REL-083"
      ],
      "resume_owner_skill_id": "SK-012",
    ...
    },
    {
      ...
      "entry_condition": "A required setup surface is missing or incompatible.",
      "failure_behavior": "Return the recommendation or suggestion without executing the target",
      "input_packet": "Caller-owned bounded Source Trace for triage and the declared repo-bootstrap input",
      "ordering_impact": "none",
      "relationship_id": "REL-085",
      "required_proof_ids": [
        "PROOF-REL-085"
      ],
    ...
    },
    {
      ...
      "combined_exit_owner_skill_id": "SK-017",
      "context_loaded": [],
      "entry_condition": "One analyzed candidate has settled domain meaning or an ADR candidate needing durable capture.",
      "failure_behavior": "Return the recommendation without invoking the target; preserve the candidate and report for user-selected continuation",
  ...
  "selected_skills": [
    ...
    },
    {
      ...
      "load_budget_class": "conditional-leaf",
      "negative_exclusion_predicates": [
        "The request does not satisfy: One design choice needs runnable evidence rather than production proof",
        "Another selected skill owns the requested outcome",
        "The action would cross a caller-owned commitment or mutation boundary"
      ],
      "owned_authority_mutation_surfaces": [
      ...
      "positive_entry_predicate": "One design choice needs runnable evidence rather than production proof",
      "primary_role": "leaf",
      "prohibited_ownership": [
        "Another selected skill's semantic decision, local mutation, proof judgment, Return, or completion",
        "Per-skill H1 outside this immutable contract slice",
    ...
    },
    {
      ...
      "contract_order": 7,
      "essential_outcome": "Design one bounded module behind a small caller-facing interface",
      "failure_return": "Return the unresolved commitment, evidence need, or wider-scan boundary",
      "invocation_mode": "implicit",
      "load_budget_class": "conditional-leaf",
      "negative_exclusion_predicates": [
        "The request does not satisfy: One module, interface, seam, adapter, ownership boundary, or caller-facing test surface needs a decision",
        "Another selected skill owns the requested outcome",
        "The action would cross a caller-owned commitment or mutation boundary"
      ],
      "owned_authority_mutation_surfaces": [
      ...
      "positive_entry_predicate": "One module, interface, seam, adapter, ownership boundary, or caller-facing test surface needs a decision",
      "primary_role": "leaf",
      "prohibited_ownership": [
        "Another selected skill's semantic decision, local mutation, proof judgment, Return, or completion",
        "Per-skill H1 outside this immutable contract slice",
      ...
      "required_input": "A bounded caller-owned Source Trace and authority for: Design one bounded module behind a small caller-facing interface",
      "return_packet": "One selected bounded design with caller-facing proof surface",
      "skill_id": "SK-007"
    },
    {
      "acceptance_scenario_ids": [
      ...
      "load_budget_class": "conditional-leaf",
      "negative_exclusion_predicates": [
        "The request does not satisfy: The current user owns one material decision that benefits from direct questioning",
        "Another selected skill owns the requested outcome",
        "The action would cross a caller-owned commitment or mutation boundary"
      ],
      "owned_authority_mutation_surfaces": [
    ...
    },
    {
      ...
      "load_budget_class": "conditional-leaf",
      "negative_exclusion_predicates": [
        "The request does not satisfy: Raw issues or configured external requests need sorting and readiness verification",
        "Another selected skill owns the requested outcome",
        "The action would cross a caller-owned commitment or mutation boundary"
      ],
      "owned_authority_mutation_surfaces": [
      ...
      "positive_entry_predicate": "Raw issues or configured external requests need sorting and readiness verification",
      "primary_role": "leaf",
      "prohibited_ownership": [
        "Another selected skill's semantic decision, local mutation, proof judgment, Return, or completion",
        "Per-skill H1 outside this immutable contract slice",
    ...
    },
    {
      ...
      "completion_condition": "The user-selected Map, Audit, or Analyze mode is complete for this invocation; current evidence identity and deterministic HTML state pass publication and read-back; the report exposes current selectable subsystems or candidates and no downstream work starts",
      "contract_order": 17,
      "essential_outcome": "Map one repository target, audit one user-selected subsystem, or analyze one user-selected candidate in one organized HTML report",
      "failure_return": "Return current, incomplete, or stale report coverage without mutating the repository baseline or selecting another item",
      "invocation_mode": "explicit-only",
      "load_budget_class": "conditional-aggregate",
      "negative_exclusion_predicates": [
        "The request does not satisfy: A repository needs a whole-system map, one user-selected subsystem audit, or one user-selected candidate analysis",
        "Another selected skill owns the requested outcome",
        "The action would cross a caller-owned commitment or mutation boundary"
      ],
      "owned_authority_mutation_surfaces": [
        "Current-source identity and strict manifest verification, linked system map, six-class coverage, findings and retained complexity, cross-subsystem patterns, candidate presentation and analysis, and the deterministic HTML report"
      ],
      "owned_capability_ids": [
        "CAP-017"
      ],
      "positive_entry_predicate": "A repository needs a whole-system map, one user-selected subsystem audit, or one user-selected candidate analysis",
      ...
      "required_input": "A repository target for Map, one current complete report and user-selected subsystem for Audit, or one current report and user-selected candidate for Analyze",
      "return_packet": "The completed mode, selected item, strongest findings or recommendation, coverage limits, absolute report path, and current user-selectable next items",
      "skill_id": "SK-017"
    },
    {
      "acceptance_scenario_ids": [
